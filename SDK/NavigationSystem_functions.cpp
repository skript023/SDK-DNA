...
// bool                                    NeedExtent                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<int32>*                          LevelId                                                (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool ARecastNavMesh::ProjectPointInDifferentLevel(const struct FVector& Point, bool NeedExtent, TArray<int32>* LevelId) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("RecastNavMesh", "ProjectPointInDifferentLevel");

	Params::RecastNavMesh_ProjectPointInDifferentLevel Parms{};

	Parms.Point = std::move(Point);
	Parms.NeedExtent = NeedExtent;
	...
	if (LevelId != nullptr)
		*LevelId = std::move(Parms.LevelId);
