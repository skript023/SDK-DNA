...
// Function AnimationBudgetAllocator.SkeletalMeshComponentBudgeted.SetAutoCalculateSignificance
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                                    bInAutoCalculateSignificance                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USkeletalMeshComponentBudgeted::SetAutoCalculateSignificance(bool bInAutoCalculateSignificance)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SkeletalMeshComponentBudgeted", "SetAutoCalculateSignificance");

	Params::SkeletalMeshComponentBudgeted_SetAutoCalculateSignificance Parms{};
