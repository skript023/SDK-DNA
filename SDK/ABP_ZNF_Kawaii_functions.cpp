...
#include "ABP_ZNF_Kawaii_classes.hpp"
#include "ABP_ZNF_Kawaii_parameters.hpp"
...
void UABP_NPC_ZNF_Kawaii_C::NewKawaiiLayer(const struct FPoseLink& InPose, bool bEnableKawaiiSetting, const class FString& CurrentKawaiiState, class UPlayerAnimInstance* OwnerInstance, bool IsPhantom, struct FPoseLink* NewKawaiiLayer_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ABP_NPC_ZNF_Kawaii_C", "NewKawaiiLayer");

	Params::ABP_NPC_ZNF_Kawaii_C_NewKawaiiLayer Parms{};
