...
{
public:
	uint8                                         Pad_0[0xB8];                                       // 0x0000(0x00B8)(Fixing Struct Size After Last Property [ Dumper-DNA ])
};
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0010(0x0360)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                         Pad_20[0x60];                                      // 0x0020(0x0060)(Fixing Struct Size After Last Property [ Dumper-DNA ])
};
