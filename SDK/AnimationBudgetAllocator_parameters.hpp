...
struct SkeletalMeshComponentBudgeted_SetAutoCalculateSignificance final
{
public:
	bool                                          bInAutoCalculateSignificance;                      // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_SkeletalMeshComponentBudgeted_SetAutoCalculateSignificance;
