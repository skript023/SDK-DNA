...
public:
	...
	uint8                                         Pad_58[0x40];                                      // 0x0058(0x0040)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_B8[0x3F0];                                     // 0x00B8(0x03F0)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_50[0x80];                                      // 0x0050(0x0080)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_50[0xB8];                                      // 0x0050(0x00B8)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_D0[0x30];                                      // 0x00D0(0x0030)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_D0[0x80];                                      // 0x00D0(0x0080)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_D0[0x40];                                      // 0x00D0(0x0040)(Fixing Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_50[0x1E0];                                     // 0x0050(0x01E0)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_D0[0x10];                                      // 0x00D0(0x0010)(Fixing Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_30[0x140];                                     // 0x0030(0x0140)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_1B8[0x80];                                     // 0x01B8(0x0080)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x02A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x02A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
