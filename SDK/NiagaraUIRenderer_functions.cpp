...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UMaterialInterface*               OriginalMaterial                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UNiagaraSystemWidget::SetAutoActivate(bool bInAutoActivate)
{
	static class UFunction* Func = nullptr;
...
bool UNiagaraSystemWidget::GetAutoActivate() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraSystemWidget", "GetAutoActivate");

	Params::NiagaraSystemWidget_GetAutoActivate Parms{};
