...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// const TArray<struct FAssetDetail>&      InAssetsDetailList                                     (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const TArray<class FString>&            InCommand                                              (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// const TArray<struct FAssetDetail>&      InAssetsDetail                                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
// Parameters:
// const TArray<struct FAssetDetail>&      InAssetsDetail                                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// const TArray<class FString>&            InIgnoreFilters                                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// TArray<struct FAssetDetail>*            OutHasRefAssetsDetail                                  (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// TArray<struct FAssetDetail>*            OutDontHasRefAssetsDetail                              (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
// const TArray<EAssetRegistryDependencyTypeEx>&SearchAssetDepTypes                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// const TArray<class FString>&            InFilterPackagePaths                                   (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
// const class FString&                    LibraryName                                            (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString&                    LibraryDir                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    bNative                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UFlibPakHelper::LoadShaderbytecode(const class FString& LibraryName, const class FString& LibraryDir, bool bNative)
{
	static class UFunction* Func = nullptr;
...
// const TSet<class FString>&              ExternFilesToIgnore                                    (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
struct FPlatformExternFiles UFlibPatchParserHelper::GetAllExFilesByPlatform(const struct FPlatformExternAssets& InPlatformConf, const TSet<class FString>& ExternFilesToIgnore, bool InGeneratedHash, EHashCalculator HashCalculator)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ExternFilesToIgnore = std::move(ExternFilesToIgnore);
...
// const class FString&                    InPakOptionalSign                                      (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    InExamineIgnore                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UFlibPatchParserHelper::GetPakFileInfo(const class FString& InFile, struct FPakFileInfo* OutFileInfo, const class FString& InPakOptionalSign, bool InExamineIgnore)
{
	static class UFunction* Func = nullptr;
	...
	Parms.InFile = std::move(InFile);
	Parms.InPakOptionalSign = std::move(InPakOptionalSign);
	Parms.InExamineIgnore = InExamineIgnore;
