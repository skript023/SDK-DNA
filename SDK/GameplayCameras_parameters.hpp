...
public:
	...
	struct FMinimalViewInfo                       POV;                                               // 0x0010(0x0630)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMinimalViewInfo                       ModifiedPOV;                                       // 0x0640(0x0630)(Parm, OutParm, NativeAccessSpecifierPublic)
};
