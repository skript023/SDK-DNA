...
public:
	...
	uint8                                         Pad_310[0x110];                                    // 0x0310(0x0110)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	class UGeometryCollectionComponent*           GeometryCollectionComponent;                       // 0x02A0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGeometryCollectionDebugDrawComponent*  GeometryCollectionDebugDrawComponent;              // 0x02A8(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_4A0[0xE0];                                     // 0x04A0(0x00E0)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_599[0x7];                                      // 0x0599(0x0007)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_5A2[0x2];                                      // 0x05A2(0x0002)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_5AC[0x4];                                      // 0x05AC(0x0004)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_5D4[0x4];                                      // 0x05D4(0x0004)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_5E1[0x3];                                      // 0x05E1(0x0003)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_5FC[0x4];                                      // 0x05FC(0x0004)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_678[0x18];                                     // 0x0678(0x0018)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_6A5[0x3];                                      // 0x06A5(0x0003)(Fixing Size After Last Property [ Dumper-DNA ])
	TMulticastInlineDelegate<void(const struct FChaosPhysicsCollisionInfo& CollisionInfo)> OnChaosPhysicsCollision; // 0x06A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_6D8[0x218];                                    // 0x06D8(0x0218)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_8F8[0x28];                                     // 0x08F8(0x0028)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	struct FGeometryCollectionDebugDrawWarningMessage WarningMessage;                                // 0x02A0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A1[0x7];                                      // 0x02A1(0x0007)(Fixing Size After Last Property [ Dumper-DNA ])
	struct FGeometryCollectionDebugDrawActorSelectedRigidBody SelectedRigidBody;                     // 0x02A8(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_354[0x4];                                      // 0x0354(0x0004)(Fixing Size After Last Property [ Dumper-DNA ])
	class UBillboardComponent*                    SpriteComponent;                                   // 0x0358(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_360[0x28];                                     // 0x0360(0x0028)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_F4[0x14];                                      // 0x00F4(0x0014)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	class UVolumeTexture*                         TargetVolumeTexture;                               // 0x02A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterial*                              RayMarchMaterial;                                  // 0x02A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_2BA[0x86];                                     // 0x02BA(0x0086)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_D3[0x1];                                       // 0x00D3(0x0001)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_128[0x10];                                     // 0x0128(0x0010)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_110[0x10];                                     // 0x0110(0x0010)(Fixing Size After Last Property [ Dumper-DNA ])
