...
void UNiagaraComponent::OnAttachedActorEndplay(class AActor* Actor, EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraComponent", "OnAttachedActorEndplay");

	Params::NiagaraComponent_OnAttachedActorEndplay Parms{};
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int32                                   QualityBias                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNiagaraComponent::SetQualityBias(int32 QualityBias)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NiagaraComponent", "SetQualityBias");

	Params::NiagaraComponent_SetQualityBias Parms{};

	Parms.QualityBias = QualityBias;
...
float UNiagaraDataChannelReader::ReadFloat(class FName VarName, int32 Index_0, bool* IsValid) const
{
	static class UFunction* Func = nullptr;
...
// class FName                             VarName                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Index_0                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   InData                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UNiagaraDataChannelWriter::WriteFloat(class FName VarName, int32 Index_0, float InData)
{
	static class UFunction* Func = nullptr;
...
// bool                                    bTickEvenWhenPaused                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// ENiagaraTickBehavior                    TickBehavior                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UNiagaraComponent* UNiagaraFunctionLibrary::SpawnSystemAtLocation(const class UObject* WorldContextObject, class UNiagaraSystem* SystemTemplate, const struct FVector& Location, const struct FRotator& Rotation, const struct FVector& Scale, bool bAutoDestroy, bool bAutoActivate, ENCPoolMethod PoolingMethod, bool bPreCullCheck, bool bTickEvenWhenPaused, ENiagaraTickBehavior TickBehavior)
{
	...
	Parms.TickBehavior = TickBehavior;
