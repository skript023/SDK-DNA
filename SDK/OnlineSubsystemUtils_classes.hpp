...
public:
	...
	uint8                                         Pad_50[0x30];                                      // 0x0050(0x0030)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x48];                                      // 0x0050(0x0048)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_50[0x40];                                      // 0x0050(0x0040)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_50[0x38];                                      // 0x0050(0x0038)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_48[0x38];                                      // 0x0048(0x0038)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_48[0x60];                                      // 0x0048(0x0060)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_48[0x48];                                      // 0x0048(0x0048)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_1BA8[0x50];                                    // 0x1BA8(0x0050)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_1BFC[0x4C];                                    // 0x1BFC(0x004C)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_761[0x3];                                      // 0x0761(0x0003)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_768[0xC];                                      // 0x0768(0x000C)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_784[0x4];                                      // 0x0784(0x0004)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_798[0x38];                                     // 0x0798(0x0038)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	TMulticastInlineDelegate<void()>              OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x130];                                     // 0x0050(0x0130)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	class UNetDriver*                             NetDriver;                                         // 0x02B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2B8[0x18];                                     // 0x02B8(0x0018)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	class AOnlineBeaconHostObject*                BeaconOwner;                                       // 0x02D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UNetConnection*                         BeaconConnection;                                  // 0x02D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_2E1[0x4F];                                     // 0x02E1(0x004F)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_2D4[0x4];                                      // 0x02D4(0x0004)(Fixing Size After Last Property [ Dumper-DNA ])
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x02D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2E8[0xA0];                                     // 0x02E8(0x00A0)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	TSubclassOf<class AOnlineBeaconClient>        ClientBeaconActorClass;                            // 0x02B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AOnlineBeaconClient*>            ClientActors;                                      // 0x02B8(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_90[0xF8];                                      // 0x0090(0x00F8)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_28[0x198];                                     // 0x0028(0x0198)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_1C2[0x6];                                      // 0x01C2(0x0006)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	uint8                                         Pad_330[0x30];                                     // 0x0330(0x0030)(Fixing Size After Last Property [ Dumper-DNA ])
	class FString                                 DestSessionId;                                     // 0x0360(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FPartyReservation                      PendingReservation;                                // 0x0370(0x0050)(Protected, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_3C3[0x2D];                                     // 0x03C3(0x002D)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	class UPartyBeaconState*                      State;                                             // 0x02C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D0[0x60];                                     // 0x02D0(0x0060)(Fixing Size After Last Property [ Dumper-DNA ])
	...
	uint8                                         Pad_33C[0x4];                                      // 0x033C(0x0004)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	...
	uint8                                         Pad_90[0x10];                                      // 0x0090(0x0010)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	TMulticastInlineDelegate<void(class APlayerController* PlayerController)> OnSuccess;             // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class APlayerController* PlayerController)> OnFailure;             // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_50[0x10];                                      // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
public:
	uint8                                         Pad_330[0x30];                                     // 0x0330(0x0030)(Fixing Size After Last Property [ Dumper-DNA ])
	class FString                                 DestSessionId;                                     // 0x0360(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FSpectatorReservation                  PendingReservation;                                // 0x0370(0x0078)(Protected, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_3EB[0x2D];                                     // 0x03EB(0x002D)(Fixing Struct Size After Last Property [ Dumper-DNA ])
...
{
public:
	class USpectatorBeaconState*                  State;                                             // 0x02C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2D0[0x60];                                     // 0x02D0(0x0060)(Fixing Size After Last Property [ Dumper-DNA ])
	bool                                          bLogoutOnSessionTimeout;                           // 0x0330(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_331[0x3];                                      // 0x0331(0x0003)(Fixing Size After Last Property [ Dumper-DNA ])
	float                                         SessionTimeoutSecs;                                // 0x0334(0x0004)(ZeroConstructor, Transient, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                         Pad_6C0[0x60];                                     // 0x06C0(0x0060)(Fixing Struct Size After Last Property [ Dumper-DNA ])
