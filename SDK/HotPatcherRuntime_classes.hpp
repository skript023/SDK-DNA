...
// Class HotPatcherRuntime.TargetPlatformRegister
// 0x0000 (0x0028 - 0x0028)
class UTargetPlatformRegister final : public UObject
{
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("TargetPlatformRegister")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"TargetPlatformRegister")
	}
	static class UTargetPlatformRegister* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTargetPlatformRegister>();
	}
};
DUMPER7_ASSERTS_UTargetPlatformRegister;
...
public:
	...
	static bool LoadShaderbytecode(const class FString& LibraryName, const class FString& LibraryDir, bool bNative);
...
public:
	...
	static struct FPlatformExternFiles GetAllExFilesByPlatform(const struct FPlatformExternAssets& InPlatformConf, const TSet<class FString>& ExternFilesToIgnore, bool InGeneratedHash, EHashCalculator HashCalculator);
	...
	static bool GetPakFileInfo(const class FString& InFile, struct FPakFileInfo* OutFileInfo, const class FString& InPakOptionalSign, bool InExamineIgnore);
