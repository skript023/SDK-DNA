...
enum class EFoliageCategory : uint8
{
	...
	VINE                                     = 5,
	COUNT                                    = 6,
	EFoliageCategory_MAX                     = 7,
};

// Enum Foliage.EFoliageLevelCategory
// NumValues: 0x0005
enum class EFoliageLevelCategory : uint8
{
	DEFAULT                                  = 0,
	REGION                                   = 1,
	DUNGEON                                  = 2,
	COUNT                                    = 3,
	EFoliageLevelCategory_MAX                = 4,
};
